...
export const PERMISOS_POR_ROL: Record<string, ModuloAcceso[]> = {
  ...
  usuario: permisosPersonalizados({
    ...
    Presupuesto: LECTURA,
    'Matriz Legal': LECTURA,
    'Gestión del Cambio': LECTURA,
    'Conservación Documental': LECTURA,
    Contratistas: LECTURA,
    'Evaluaciones Médicas': LECTURA,
    'Perfiles de Cargo': LECTURA,
    'Seguimiento Casos Médicos': LECTURA,
